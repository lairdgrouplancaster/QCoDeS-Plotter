Files in this folder are test scripts written by Ben Wordsworth, presumably to help his original development. The documentation below and in the scripts was generated by Codex.

# Scripts

These scripts are local development helpers. They are not installed as package
entry points.
